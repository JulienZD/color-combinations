    ...
    <>
      <figure className="flex flex-col mx-1 relative h-32 group focus-visible:ring focus-visible:ring-blue-300">
        <PopoverColorPicker className="flex-grow" color={color} onSelection={updateColor}>
          <div
            className="h-full rounded-md cursor-pointer border border-secondary focus-visible:ring focus-visible:ring-blue-300 transition-all duration-200 hover:scale-[1.02] hover:shadow-lg"
